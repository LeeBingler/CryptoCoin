...
function Market() {
    const numberOfPageMarket = 5;
    const [currrentPage, setCurrentPage] = useState('1');
    const url = `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=${numberOfPageMarket}&page=${currrentPage}&sparkline=false&locale=en`;
        ...
        <section className='marketContainer' id='Market'>
            <article className='market'>
                ...
                <div>
                    ...
                    {error ? <p> Error Try Later: {error.message}</p> : null}
                    {!isLoading && !error
                    ...
                    {!isLoading && !error ? (
                        <ListPagination
                            ...
                            numberOfPage={numberOfPageMarket}
